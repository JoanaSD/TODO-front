class Tarea{
    ...
    borrarTarea(){
        fetch("https://api-todo-clase-n5io.onrender.com/api-todo/borrar/" + this.id, {
            method: "DELETE"       
        })
    ...
    toggleEstado(){
        return fetch(`https://api-todo-clase-n5io.onrender.com/api-todo/actualizar/${this.id}/2`, {
                method : "PUT"
        })
        .then(respuesta => respuesta.json());
    }
    ...
    async editarTarea(){
        if(this.editando){
            ...
            if(textoTemporal.trim() != "" && textoTemporal.trim() != this.textoTarea){
                ...
                let {resultado} = await fetch(`https://api-todo-clase-n5io.onrender.com/api-todo/actualizar/${this.id}/1`, {
                    method : "PUT",
